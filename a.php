		...
		<div class="col-md-4">
			...
			<div id="links_panel" class="panel panel-default panel_overflow">
				...
				<ul class="list-group">
					...
					<li class="list-group-item"><a href="/pubinfo/list170317.pdf"> USS Placement Coordinators</li>
				...
				</ul><div class="panel-footer"> <a class="custom-btn" href="schools.php">UNIVERSITY SCHOOLS »</a> </div>
			</div>

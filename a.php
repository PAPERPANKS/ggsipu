			...
			<div id="menu" style="margin-top:40px">
				...
				<div id="menuzord" class="menuzord red">
					...
					<ul class="menuzord-menu">
						<li>
							<a href="javascript:void(0)">Discover GGSIPU</a>
							<div class="megamenu" id="discover_ipu" style="border-radius: 15px;">
								...
								<div class="megamenu-row">
									...
									<div class="col3">
										<br>
										<ul color="#666362" class="globaldropdown">
											</br> 
							...
							<div id="academics_head" class="megamenu" style="border-radius: 15px;">
								<div class="megamenu-row">
									<div class="col6">
										...
										<ul class="globaldropdown" color="#666362">
											</br> 
						...
						<div id="events_panel" class="panel panel-default panel_overflow">
							...
							<ul class="list-group">
								<li class="list-group-item">
									<a href="/nirfmain.php">National Institutional Ranking Framework - 2019</a>
								</li>
								<li class="list-group-item">
									<a href="/ddnaacmain.php">IIQAC & NAAC</a>
								</li>
								<li class="list-group-item">
									<a href="/photoalubmmain.php">Photographs of various events</a>
								</li>
								<li class="list-group-item">
									<a href="http://142.93.210.160/#/">Faculty Feedback System <br>(Only for USS)</a>
								</li>
								<li class="list-group-item">
									<a href="http://www.cvc.nic.in/">CVC - Integrity Pledge </a>
								</li>
								<li class="list-group-item">
									<a href="https://edistrict.delhigovt.nic.in/">Merit-cum-Means Income Linked Financial Scheme for students of State Universities of Delhi </a>
								</li>
								<li class="list-group-item">
									<a href="/dsw_ews.php">Financial Assistance to the students Under Economically Weaker Section (EWS) Scheme-2018</a>
								</li>
								<li class="list-group-item">
									<a href="http://bit.ly/acm-usict">ACM-USICT</a>
								</li>
							</ul>
							<div class="panel-footer"> <a class="custom-btn" href="notices.php">NOTICES/ CIRCULARS »</a> </div>
						</div>
					</div>
					<div class="col-md-4">
						<div id="links_panel" class="panel panel-default panel_overflow">
							...
							<!-- List group -->
							<ul class="list-group">
								<li class="list-group-item"><a href="/dsw.php"> Student's Welfare</a></li>
								<li class="list-group-item"><a href="/alumni_usict.php"> Alumni</a></li>
								<li class="list-group-item">
									<a href="/pubinfo/list170317.pdf">
										USS Placement Coordinators
								</li>
								<li class="list-group-item"><a href="/nsscellmain.php"> NSS</a></li>
								<li class="list-group-item"><a href="/careers.php"> Jobs / Opportunities</a></li>
								<li class="list-group-item"><a href="/career_plcmnt.php"> Centralized Career Guidance and Placement Cell (CCGPC)</a></li>
								<li class="list-group-item"><a href="/pubinfo/list170317.pdf"> USS Placement Coordinators</a></li>
								<li class="list-group-item"><a href="/library.php"> UIRC (Library)</a></li>
								<li class="list-group-item"><a href="https://payments.billdesk.com/bdcollect/pay?p1=137&p2=14"> Annual Fee Payment for 2018-19</a></li>
							</ul>
							<div class="panel-footer"> <a class="custom-btn" href="schools.php">UNIVERSITY SCHOOLS »</a> </div>
						</div>
					</div>
					<div id="alerts_panel" class="col-md-4">
						<div class="panel panel-default">
							...
							<div class="vertical_marquee">
								...
								<ul class=" list-group marquee">
									<li class="list-group-item">
										<a href="http://ggsipu.ac.in/ipuaffiliation/Login.aspx">Apply Online for Grant / Continuation of Provisional Affiliation</a>
									</li>
									<li class="list-group-item">
										<a href="https://in.mathworks.com/academia/tah-portal/guru-gobind-singh-indraprastha-university-40781459.html">Register / Download MATLAB, Simulink and several 
										add-on products for use by faculty, academic researchers and students</a>
									</li>
									<li class="list-group-item">
										<a href="/pubinfo/ntcourt281118.pdf">Interim directions of the Hon'ble High Court of Delhi regarding Examination of Nov./Dec. 2018</a>
									</li>
									<li class="list-group-item">
										<a href="https://payments.billdesk.com/bdcollect/pay?p1=137&p2=14">Annual Fee Payment for 2018-19</a>
									</li>
									<li class="list-group-item">
										<a href="/sports.php">Sports Activities</a>
									</li>
									<li class="list-group-item">
										<a href="/pubinfo/nssvdrv220318.pdf">NSS Volunteers Enrolment drive</a>
									</li>
									<li class="list-group-item">
										<a href="/pubinfo/enrol160418.pdf">NSS Teaching & Non-Teaching Enrollment Drive</a>
									</li>
									<li class="list-group-item">
										<a href="/cancellation_admission.php">Cancellation of Admission / Re-admission</a>
									</li>
									<li class="list-group-item">
										<a href="/careers.php">Jobs & Opportunities</a>
									</li>
									<li class="list-group-item">
										<a href="/nirfmain.php">National Institutional Ranking Framework</a>
									</li>
									<li class="list-group-item">
										<a href="/disabledmain.php">Differently abled Students</a>
									</li>
									<li class="list-group-item">
										<a href="/admission2016/phd2016/guidelines.pdf">Faculty Research Grant Scheme</a>
									</li>
								</ul>
							</div>
						</div>
